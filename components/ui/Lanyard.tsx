...
// Tell @react-three/fiber about the meshline custom elements
...
// Public-folder asset paths (no Vite import needed)
...
function Band({
  ...
  const cardMap = useMemo(() => {
    ...
    const drawFitted = (img: HTMLImageElement, rect: UVRect) => {
...
// Pre-load the GLB so it's ready before the section is visible
